#!/usr/bin/env node
/**
 * Focused story-ingestion regression gate for the model-homonym / durability fixture.
 *
...
const serverTests = [
  'tests/services/chat/storyIngestionModelHomonym.regression.test.ts',
  'tests/services/chat/durabilityApiContract.test.ts',
  'src/services/conversationCentered/datingEligibility.test.ts',
].join(' ');

const webTests = [
  'src/features/chat/hooks/__tests__/useChat.modelHomonymRecovery.test.tsx',
