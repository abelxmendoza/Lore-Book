-- Recreate ERD helper views after dependent tables exist.
-- The original 20250127000046 migration is a no-op when location_mentions
-- (and other deps) are not yet created.
