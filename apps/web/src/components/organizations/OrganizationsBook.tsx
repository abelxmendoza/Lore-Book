...
const normalizeOrganization = (raw: Partial<Organization>): Organization => {
  ...
  return {
    ...
    parent_group_id: raw.parent_group_id ?? null,
    members,
    stories,
    events,
    locations,
...
const MOCK_ORGANIZATIONS: Organization[] = [
...

  {
    id: 'mock-brasstones',
    name: 'The Brasstones',
    aliases: ['Brasstones', 'The Brasstones Band'],
    type: 'other', group_type: 'band',
    membership_model: 'none', user_relationship: 'fan', is_public_entity: true,
    description: 'Official band entity. Demo mode treats The Brasstones as a group/organization, not a character, and keeps the corrected identity locked for future mentions.',
    ...
    metadata: {
      ...
      manual_identity_correction: {
        ...
        description: 'The Brasstones is a band.',
        status: 'active',
      },
    },
    members: [],
    stories: [
      {
        ...
        summary: 'The card was moved out of the character book after you clarified that The Brasstones is a band. The corrected identity should drive future detection.',
        date: subDays(new Date(), 1).toISOString(),
      },
      {
        id: 's2',
        title: 'Repeated story mention',
        summary: 'The Brasstones came up while you were talking about music references in the story, not as a person in the cast.',
...

  {
    ...
    locations: [
      { id: 'l-nw-depot', location_id: 'dummy-loc-nw-depot', location_name: 'Northwind Depot', visit_count: 6, last_visited: subDays(new Date(), 4).toISOString() },
      { id: 'l-hw-lab', location_id: 'dummy-loc-hw-lab', location_name: 'Hollywood lab', visit_count: 3, last_visited: subDays(new Date(), 11).toISOString() },
    ],
...

  {
    id: 'mock-22',
    name: 'Field Crew',
    aliases: ['Northwind field crew'],
    type: 'other', group_type: 'team',
    membership_model: 'fuzzy', user_relationship: 'adjacent', is_public_entity: false,
    description: 'On-site logistics team at Northwind Depot — receiving, yard, and outbound loads.',
    ...
    updated_at: subDays(new Date(), 4).toISOString(),
    parent_group_id: 'mock-20',
    metadata: { subcategory: 'department', parent_company: 'Northwind Logistics' },
    members: [
      { id: 'm1', character_name: 'Gary', role: 'Yard lead', status: 'active' },
      { id: 'm2', character_name: 'Jeff', role: 'Dispatcher', status: 'active' },
    ],
    stories: [
      { id: 's1', title: 'Depot walkthrough', summary: 'Gary showed the inbound docks and the night-shift handoff board.', date: subDays(new Date(), 4).toISOString(), related_members: ['Gary'] },
    ],
    events: [{ id: 'e1', title: 'Depot shift huddle', date: subDays(new Date(), 4).toISOString(), type: 'work' }],
    locations: [
      { id: 'l-field-depot', location_id: 'dummy-loc-nw-depot', location_name: 'Northwind Depot', visit_count: 6, last_visited: subDays(new Date(), 4).toISOString() },
    ],
    analytics: mkAnalytics(44, 70, 'increasing', ['Clear site assignment'], ['Still ramping']),
  },

  {
    id: 'mock-24',
    name: 'Night Shift',
    aliases: ['Northwind night shift'],
    type: 'other', group_type: 'team',
    membership_model: 'fuzzy', user_relationship: 'adjacent', is_public_entity: false,
    description: 'Overnight receiving and yard coverage at Northwind Depot — shares the site with Field Crew.',
    location: 'Northwind Depot',
    status: 'active',
    member_count: 1,
    usage_count: 4,
    confidence: 0.82,
    last_seen: subDays(new Date(), 6).toISOString(),
    created_at: subDays(new Date(), 36).toISOString(),
    updated_at: subDays(new Date(), 6).toISOString(),
    parent_group_id: 'mock-20',
    metadata: { subcategory: 'department', parent_company: 'Northwind Logistics' },
    members: [
      { id: 'm1', character_name: 'Alex', role: 'Night lead', status: 'active' },
    ],
    stories: [
      { id: 's1', title: 'Graveyard inbound', summary: 'Alex ran the overnight dock board when the day crew handed off.', date: subDays(new Date(), 6).toISOString(), related_members: ['Alex'] },
    ],
    events: [{ id: 'e1', title: 'Night dock handoff', date: subDays(new Date(), 6).toISOString(), type: 'work' }],
    locations: [
      { id: 'l-night-depot', location_id: 'dummy-loc-nw-depot', location_name: 'Northwind Depot', visit_count: 4, last_visited: subDays(new Date(), 6).toISOString() },
    ],
    analytics: mkAnalytics(32, 58, 'stable', ['Shares the depot with Field Crew'], ['Thin roster']),
  },

  {
    id: 'mock-23',
    name: 'QA Lab',
    aliases: ['Hollywood QA'],
    type: 'other', group_type: 'team',
    membership_model: 'fuzzy', user_relationship: 'adjacent', is_public_entity: false,
    description: 'Inspection and returns group based at the Hollywood lab for Northwind Logistics.',
    location: 'Hollywood lab',
    status: 'active',
    member_count: 1,
    usage_count: 5,
    confidence: 0.84,
    ...
    metadata: { subcategory: 'department', parent_company: 'Northwind Logistics' },
    members: [
      { id: 'm1', character_name: 'Taylor', role: 'QA tech', status: 'active' },
    ],
    stories: [
      { id: 's1', title: 'Returns bench', summary: 'Taylor walked through damaged-parcel intake at the Hollywood lab.', date: subDays(new Date(), 11).toISOString(), related_members: ['Taylor'] },
    ],
    events: [{ id: 'e1', title: 'Lab inspection window', date: subDays(new Date(), 11).toISOString(), type: 'work' }],
    locations: [
      { id: 'l-qa-lab', location_id: 'dummy-loc-hw-lab', location_name: 'Hollywood lab', visit_count: 3, last_visited: subDays(new Date(), 11).toISOString() },
    ],
    analytics: mkAnalytics(36, 62, 'stable', ['Site-specific team'], ['Small roster']),
  },
