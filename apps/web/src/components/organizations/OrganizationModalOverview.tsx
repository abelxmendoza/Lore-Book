...
export function OrganizationModalOverview({
  ...
  return (
    <div className="space-y-3 sm:space-y-4 pb-2">
        ...
        <section className="rounded-xl border border-white/10 bg-black/40 p-3">
          ...
          <div className="flex gap-2 overflow-x-auto scrollbar-none pb-0.5">
            {members.slice(0, 8).map((m) => (
              ...
              >
                <div className="h-9 w-9 rounded-full bg-white/10 border border-white/15 flex items-center justify-center text-xs font-bold text-white/80 group-hover:border-primary/40">
      ...
      {(latestDerived || latestRecorded || latestStory) && (
          ...
          {latestDerived && (
            ...
            >
              ...
              {latestDerived.summary && (
                <p className="text-[11px] text-white/45 line-clamp-2 mt-0.5">{latestDerived.summary}</p>
              )}
            </button>
          )}
