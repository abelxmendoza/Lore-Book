...
describe('Sidebar', () => {
  ...
  it('renders story-entity nav: Characters, Locations, Events, Groups, Skills, Love & Relationships', () => {
    render(<Sidebar {...defaultProps} />);
    ...
    expect(screen.getAllByRole('button', { name: /Open events view/i }).length).toBeGreaterThanOrEqual(1);
