...
export const Footer = () => {
  return (
    <footer className="mt-auto -mx-4 -mb-4 sm:-mx-6 sm:-mb-6 lg:-mx-8 lg:-mb-8 xl:-mx-10 xl:-mb-10 border-t border-border/60 bg-black px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 text-xs sm:text-sm text-white/70 safe-area-bottom">
