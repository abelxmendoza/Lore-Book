export const EmotionalTrajectoryGraph = ({
  ...
  <div className="rounded-lg border border-brand-cyan/30 bg-brand-cyan/5 p-3">
    <div className="grid grid-cols-4 items-end gap-2 text-center text-xs">
      {points.map((point) => (
        <div key={point.label} className="space-y-1">
          <div
            className="mx-auto w-full rounded bg-gradient-to-t from-brand-cyan/30 to-primary"
