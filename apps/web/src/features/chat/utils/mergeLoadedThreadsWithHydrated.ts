 ...
 *
 * - Keeps hydrated messages (and fresher activity timestamps) from prev
 * - Preserves optimistic / not-yet-acked threads so create+prompt races
 *   don't drop conversations on login or refetch
 * - Always returns activity order so desktop/mobile/login stay consistent
 */
