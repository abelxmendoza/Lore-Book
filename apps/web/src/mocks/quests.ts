...
export const MOCK_QUESTS: Quest[] = [
  ...
  },
  {
    ...
    motivation_notes: 'Marcus encouraged me to take this course as part of my creative transition. Alex Rivera is helping me practice, and Alex (my boyfriend) is supportive of this journey.',
  ...
  },
  {
    ...
    description: 'Declutter and organize my home studio space. Set up proper cable management for music equipment and create an inspiring creative workspace. Alex (my boyfriend) is helping me with this.',
    quest_type: 'side',
    priority: 6,
    importance: 5,
    impact: 4,
