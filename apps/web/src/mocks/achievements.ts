...
export const MOCK_APP_ACHIEVEMENTS: Achievement[] = [
  // Common Achievements
  {
    ...
    description: 'Wrote your first journal entry during your creative transition. This marked the beginning of documenting your journey from tech to creative work.',
    icon_name: 'book-open',
  ...
  },
  {
    ...
    description: '7 days of consecutive journaling during your creative renaissance. You documented your music production sessions with Alex Rivera, writing sessions with Sarah, and relationship milestones with Alex.',
    icon_name: 'flame',
  ...
  // Uncommon Achievements
  {
    ...
    description: 'Reached level 10 in Music Production. After months of learning with Alex Rivera in your home studio, you\'ve mastered the fundamentals and are working on your first EP.',
    icon_name: 'award',
