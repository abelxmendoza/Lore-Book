  ...
  return [
    {
      ...
      social_media: {},
      memory_count: 5, // matches generateNarrativeMemories() linked_characters count
    ...
    },
    {
      ...
      memory_count: 4, // matches generateNarrativeMemories() linked_characters count (ep-concept 1,2,3,4)
      relationship_count: 3,
    },
    {
      id: ENTITY_IDS.SARAH_CHEN,
      name: 'Sarah Chen',
      first_name: 'Sarah',
      last_name: 'Chen',
      alias: ['Sarah'],
      ...
      importance_score: 80,
      is_nickname: false,
      summary: 'Close friend who introduced me to Alex. We meet at the coffee shop often.',
      tags: ['friend', 'creative', 'supportive'],
      metadata: {
        relationship_type: 'friend',
        closeness_score: 75,
        relationships: {
          [ENTITY_IDS.ALEX_BOYFRIEND]: { type: 'friend', closeness: 75 },
          [ENTITY_IDS.MARCUS_JOHNSON]: { type: 'friend', closeness: 70 },
        },
        locations: {
          [ENTITY_IDS.COFFEE_SHOP]: { visit_count: 24, first_visit: oneYearAgo.toISOString(), last_visit: new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000).toISOString() },
          [ENTITY_IDS.HOME_STUDIO]: { visit_count: 12, first_visit: sixMonthsAgo.toISOString(), last_visit: new Date(now.getTime() - 30 * 24 * 60 * 60 * 1000).toISOString() },
        },
        skills: {
          [ENTITY_IDS.CREATIVE_WRITING]: { role: 'practiced_with', level_contribution: 6 },
        },
      },
      social_media: {},
      memory_count: 0, // no memories in generateNarrativeMemories reference Sarah
      relationship_count: 4,
    },
    {
      id: ENTITY_IDS.MARCUS_JOHNSON,
      name: 'Marcus Johnson',
      first_name: 'Marcus',
      last_name: 'Johnson',
      alias: ['Marcus'],
      ...
      importance_score: 72,
      is_nickname: false,
      summary: 'Friend who introduced me to Alex Rivera. We hang out at the coffee shop.',
      tags: ['friend', 'connector'],
      metadata: {
        relationship_type: 'friend',
        closeness_score: 70,
        relationships: {
          [ENTITY_IDS.ALEX_RIVERA]: { type: 'friend', closeness: 80 },
          [ENTITY_IDS.SARAH_CHEN]: { type: 'friend', closeness: 70 },
        },
        locations: {
          [ENTITY_IDS.COFFEE_SHOP]: { visit_count: 20, first_visit: oneYearAgo.toISOString(), last_visit: new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000).toISOString() },
        },
      },
      social_media: {},
      memory_count: 0, // no memories in generateNarrativeMemories reference Marcus
      relationship_count: 3,
    },
  ];
}
...
function generateNarrativeLocations(): NarrativeLocation[] {
  return [
    ...
    {
      id: ENTITY_IDS.YOUR_APARTMENT,
      name: 'Your Apartment',
      visitCount: 2,
      firstVisited: new Date(now.getTime() - 120 * 24 * 60 * 60 * 1000).toISOString(),
      lastVisited: new Date(now.getTime() - 120 * 24 * 60 * 60 * 1000).toISOString(),
      coordinates: { lat: 37.7749, lng: -122.4194 },
      relatedPeople: [],
      tagCounts: [{ tag: 'home', count: 2 }],
      chapters: [],
      moods: [{ mood: 'romantic', count: 2 }],
      entries: [],
      sources: ['journal'],
      associated_characters: [{ character_id: ENTITY_IDS.ALEX_BOYFRIEND, visit_count: 2 }],
      associated_skills: [],
      associated_events: [ENTITY_IDS.I_LOVE_YOU_ALEX],
      analytics: { visit_frequency: 0, recency_score: 80, total_visits: 2, importance_score: 70, priority_score: 60, relevance_score: 70, value_score: 80, sentiment_score: 95, comfort_score: 100, productivity_score: 20, social_score: 90, activity_diversity: 20, engagement_score: 85, associated_people_count: 1, first_visited_days_ago: 120, trend: 'stable', primary_purpose: ['home'], associated_activities: ['relationship'] },
    },
    {
      id: ENTITY_IDS.FANCY_RESTAURANT,
      name: 'Fancy Restaurant',
      visitCount: 1,
      firstVisited: new Date(now.getTime() - 90 * 24 * 60 * 60 * 1000).toISOString(),
      lastVisited: new Date(now.getTime() - 90 * 24 * 60 * 60 * 1000).toISOString(),
      coordinates: { lat: 37.7849, lng: -122.4094 },
      relatedPeople: [],
      tagCounts: [{ tag: 'date', count: 1 }],
      chapters: [],
      moods: [{ mood: 'romantic', count: 1 }],
      entries: [],
      sources: ['journal'],
      associated_characters: [{ character_id: ENTITY_IDS.ALEX_BOYFRIEND, visit_count: 1 }],
      associated_skills: [],
      associated_events: [ENTITY_IDS.THREE_MONTH_ANNIVERSARY],
      analytics: { visit_frequency: 0, recency_score: 75, total_visits: 1, importance_score: 65, priority_score: 55, relevance_score: 65, value_score: 85, sentiment_score: 90, comfort_score: 95, productivity_score: 10, social_score: 95, activity_diversity: 10, engagement_score: 80, associated_people_count: 1, first_visited_days_ago: 90, trend: 'stable', primary_purpose: ['date'], associated_activities: ['relationship'] },
    },
  ];
}
...
function generateNarrativeEvents(): NarrativeEvent[] {
  ...
  return [
    ...
    },
    {
      ...
      title: 'First Writing Session',
      start_time: new Date(now.getTime() - 60 * 24 * 60 * 60 * 1000).toISOString(),
      end_time: new Date(now.getTime() - 60 * 24 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000).toISOString(),
      type: 'creative_session',
      characters: [ENTITY_IDS.SARAH_CHEN], // Sarah Chen
      locations: [ENTITY_IDS.COFFEE_SHOP],
      skills: [ENTITY_IDS.CREATIVE_WRITING],
      memories: [],
      summary: 'First creative writing session with Sarah at the coffee shop.',
    },
  ];
}
...
function generateNarrativeMemories(): NarrativeMemory[] {
  ...
  return [
    ...
    },
    {
      ...
      source: 'journal',
      sourceIcon: '📖',
      characters: [ENTITY_IDS.ALEX_BOYFRIEND, 'dummy-3'], // Alex (boyfriend), Alex Rivera
      linked_characters: [ENTITY_IDS.ALEX_BOYFRIEND, 'dummy-3'],
      linked_locations: [ENTITY_IDS.HOME_STUDIO],
      linked_events: [ENTITY_IDS.EP_CONCEPT_SESSION],
      linked_skills: [ENTITY_IDS.MUSIC_PRODUCTION],
      linked_memories: ['mem-ep-concept-2'],
