...
export const demoOrganizationOptions: DemoOrganizationSummary[] = [
  ...
  },
  {
    ...
    description: 'Company with multiple sites and nested teams.',
  },
  {
    id: 'mock-22',
    name: 'Field Crew',
    ...
    status: 'active',
    user_relationship: 'adjacent',
    description: 'On-site crew at Northwind Depot.',
  },
  {
    id: 'mock-24',
    name: 'Night Shift',
    ...
    status: 'active',
    user_relationship: 'adjacent',
    description: 'Overnight crew at Northwind Depot.',
  },
  {
    id: 'mock-23',
    name: 'QA Lab',
    ...
    status: 'active',
    user_relationship: 'adjacent',
    description: 'QA team at the Hollywood lab.',
  },
];
...
let demoLinks: DemoLocationOrganizationLink[] = [
  ...
  {
    id: 'demo-org-location-nw-company',
    organization_id: 'mock-20',
    location_id: 'dummy-loc-nw-depot',
    location_name: 'Northwind Depot',
    visit_count: 6,
    organization: demoOrganizationOptions.find((org) => org.id === 'mock-20')!,
  },
  {
    id: 'demo-org-location-hw-company',
    organization_id: 'mock-20',
    location_id: 'dummy-loc-hw-lab',
    location_name: 'Hollywood lab',
    visit_count: 3,
    organization: demoOrganizationOptions.find((org) => org.id === 'mock-20')!,
  },
  {
    id: 'demo-org-location-field-crew',
    organization_id: 'mock-22',
    location_id: 'dummy-loc-nw-depot',
    location_name: 'Northwind Depot',
    visit_count: 6,
    organization: demoOrganizationOptions.find((org) => org.id === 'mock-22')!,
  },
  {
    id: 'demo-org-location-night-shift',
    organization_id: 'mock-24',
    location_id: 'dummy-loc-nw-depot',
    location_name: 'Northwind Depot',
    visit_count: 4,
    organization: demoOrganizationOptions.find((org) => org.id === 'mock-24')!,
  },
  {
    id: 'demo-org-location-qa-lab',
    organization_id: 'mock-23',
    location_id: 'dummy-loc-hw-lab',
    location_name: 'Hollywood lab',
    visit_count: 3,
    organization: demoOrganizationOptions.find((org) => org.id === 'mock-23')!,
  },
];
