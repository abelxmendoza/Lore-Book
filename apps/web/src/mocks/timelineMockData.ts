...
export const generateMockTimelines = (): Timeline[] => {
  ...
  const timelines: Timeline[] = [
    ...
    // ============================================
    {
      ...
      description: 'A long narrative arc about my journey into music production. From buying my first MIDI controller to releasing my first EP, this saga tells the complete story of my musical evolution. Marcus introduced me to Alex Rivera, who became my music production collaborator. We work together in my home studio, and Alex (my boyfriend) has been supportive throughout this journey.',
      timeline_type: 'skill',
    ...
    // ============================================
    {
      ...
      description: 'The first chapter of the EP arc—where the initial idea was born during a late-night session in my home studio. This chapter captures the moment of inspiration, the early sketches, and the vision that would guide the entire project. I called Alex (my boyfriend) to tell him about the concept, and he was excited for me.',
      timeline_type: 'custom',
