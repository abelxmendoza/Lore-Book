...
export const generateMockLifeArcs = (): LifeArc[] => {
  ...
  const arcs: ArcSeed[] = [
    ...
    },
    {
      ...
      end_date: null,
      is_active: true,
      summary: 'Building a fictional indie app on nights and weekends. Slower than a startup but more intentional. Every decision feels meaningful.',
      confidence: 0.78,
      source: 'inferred',
    ...
    },
    {
      ...
      end_date: null,
      is_active: true,
      summary: 'Picked up journaling seriously, then started writing essays. A side project became an excuse to think more carefully about narrative. The writing and the app have grown together.',
      confidence: 0.71,
      source: 'inferred',
    ...
    },
    {
      ...
      end_date: null,
      is_active: true,
      summary: 'The overarching personal shift. Stopped optimizing for career metrics and started building a life that actually felt like mine. Music, writing, a side project, Alex — all grew from this.',
      confidence: 0.91,
      source: 'user_created',
