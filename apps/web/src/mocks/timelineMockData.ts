...
export const generateMockTimelines = (): Timeline[] => {
  ...
  const timelines: Timeline[] = [
    ...
    // ============================================
    {
      ...
      description: 'A significant period within the transformation epoch where I rediscovered my creative passions. This era marked my return to art, music, and storytelling after years of focusing solely on career.',
    ...
    // ============================================
    {
      ...
      description: 'A long narrative arc about my journey into music production. From buying my first MIDI controller to releasing my first EP, this saga tells the complete story of my musical evolution.',
      timeline_type: 'skill',
    ...
    // ============================================
    {
      ...
      description: 'A story arc within the music production saga—the journey of creating my first complete album. This arc follows the progression from concept to completion, with all its challenges and breakthroughs.',
      timeline_type: 'custom',
    ...
    // ============================================
    {
      ...
      description: 'The first chapter of the album arc—where the initial idea was born. This chapter captures the moment of inspiration, the early sketches, and the vision that would guide the entire project.',
      timeline_type: 'custom',
    ...
    // ============================================
    {
      ...
      description: 'A specific scene within the concept chapter—that late night when the album concept fully crystallized. Sitting in my studio at 2am, everything clicked into place.',
      timeline_type: 'custom',
