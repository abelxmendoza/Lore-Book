...
import { parseFlag, resolveAccount } from '../../lib/auditCommon';
...
export async function runLifeArcSynthesisAudit(argv: string[] = []): Promise<void> {
  const fullRag = parseFlag(argv, '--full-rag');
  console.log('\n=== Life Arc & Story Intelligence Audit ===\n');
