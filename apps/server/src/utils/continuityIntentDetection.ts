...
const CONTINUITY_PHRASES = [
  ...
  /\b(add (this|that|it|them) to (the|my) (timeline|memoir|lore|lorebook|lorekeeper|character book|characters book|creation journey|journey))\b/i,
  /\b(save (this|that|it|them) (to|in|for) (the|my) (timeline|memoir|lore|lorebook|lorekeeper|character book|characters book|creation journey|journey))\b/i,
  /\bmake sure (?:they('re| are)|this is|that is) (?:all )?(?:in|added to|saved (?:in|to)) my (?:character book|characters book)\b/i,
