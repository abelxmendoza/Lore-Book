...
export const AUTOBIOGRAPHICAL_SAMPLES: MemoryQualitySample[] = [
  // ── Core quality fixtures ──────────────────────────────────────────────
  {
    ...
    entities: { people: ['Dollyfied', 'Stimkybun', 'Genni'], places: ['Catch One', 'Anime Expo'] },
    expected: {
      people: ['Dollyfied', 'Stimkybun', 'Genni'],
      places: ['Catch One', 'Anime Expo'],
      lessons: ['respect boundaries', 'boundaries'],
      pastEventHints: ['Genni'],
      behaviorChanges: ['boundary', 'respect'],
      relationshipDimensions: [{ person: 'tía', dimension: 'family' }],
      mustNotInvent: ['married Genni', 'owns Catch One', 'hates Dollyfied'],
    },
    expectedEventCountRange: [1, 4],
  },
  {
    id: 'e2e-genni-catch',
    text: `The situation with Genni taught me that I need to respect people's boundaries. At the Catch One afterparty, one woman pulled away while we were dancing, so I stopped and gave her space. I was disappointed that I didn't go home with anyone, but I'm glad I didn't pressure anybody.`,
    entities: { people: ['Genni'], places: ['Catch One'] },
    expected: {
      people: ['Genni'],
      places: ['Catch One'],
  ...
  { id: 'short-casual', text: 'hung w/ mala at catch one. genni stuff still in my head. backed off when she pulled away.', expected: { mustNotInvent: ['married'] } },
  { id: 'runon', text: "so yeah i was at the afterparty and this girl pulled away and i just stopped cause of what genni taught me about boundaries and i was kinda sad i went home alone but glad i didnt push it", expected: { lessons: ['boundaries'], pastEventHints: ['genni'], mustNotInvent: [] } },
  ...
  { id: 'neutral-fact', text: 'I arrived at Catch One at 11pm. Dollyfied was there. We danced.', expected: { people: ['Dollyfied'], places: ['Catch One'], mustNotInvent: ['identity growth'] }, entities: { people: ['Dollyfied'], places: ['Catch One'] } },
  ...
  { id: 'paraphrase-genni-1', text: 'What happened with Genni taught me to give people space when they pull away.', expected: { lessons: ['space', 'pull'], pastEventHints: ['Genni'], mustNotInvent: [] } },
  { id: 'paraphrase-genni-2', text: 'Because of Genni I respect boundaries more. At the club I stopped when she moved back.', expected: { lessons: ['boundaries'], pastEventHints: ['Genni'], mustNotInvent: [] } },
  { id: 'counter-no-lesson', text: 'Genni texted me about the party. Nothing deep.', expected: { mustNotInvent: ['taught me', 'identity growth'] } },
];
