...
export const CONTINUITY_SCENARIOS: ContinuityScenario[] = [
  ...
  {
    id: 'B_behavioral_jenna',
    title: 'Behavioral continuity — Jenna lesson',
    domain: 'boundaries',
    earlierDays: [
      { day: 3, user: 'The situation with Jenna taught me to respect boundaries.' },
    ],
    storedEvidence: [
      {
        memoryId: 'm-jenna-lesson',
        memoryType: 'lesson',
    ...
    requiredContinuity: ['boundar', 'Jenna'],
  ...
  },
  {
    ...
    domain: 'dating',
    earlierDays: [{ day: 3, user: 'The Jenna situation taught me to respect boundaries.' }],
    storedEvidence: [
      {
        memoryId: 'm-jenna2',
        memoryType: 'lesson',
    ...
    laterMessage: 'I almost pushed for another dance with Jenna but stopped myself.',
    requiredContinuity: ['Jenna', 'boundar'],
    forbiddenContinuity: [],
  },
