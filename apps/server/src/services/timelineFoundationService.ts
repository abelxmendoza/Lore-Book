 ...
 *
 * Memory + Characters + Relationships → canonical resolved_events.
 * Character participation is people[] on resolved_events.
 */
...
class TimelineFoundationService {
   ...
   * linked to, then creates resolved_events with people[].
   */
