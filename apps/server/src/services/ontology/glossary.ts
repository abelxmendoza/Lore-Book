...
import { LORE_COLLECTING_GLOSSARY_ENTRIES } from './glossaryLoreCollecting';
...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  E({ keyword: 'romantic_coparent', aliases: ['baby mama', 'baby momma', 'baby daddy', 'baby dad', 'co-parent', 'coparent', 'co parenting', 'kids with', 'shared custody', 'share custody'], domain: 'CONCEPT', category: 'RELATIONSHIP_VERB', weight: 0.8, confidence: 0.78, relationshipHint: 'ROMANTIC_RELATIONSHIP' }),
  ...
  E({ keyword: 'romantic_ended', aliases: ['my ex', 'ex boyfriend', 'ex girlfriend', 'ex wife', 'ex husband', 'broke up', 'breakup', 'split up', 'ended things', 'we broke up', 'divorced', 'got divorced', 'we divorced', 'ex spouse'], domain: 'CONCEPT', category: 'RELATIONSHIP_VERB', weight: 0.8, confidence: 0.78, relationshipHint: 'ROMANTIC_RELATIONSHIP' }),
  ...
  E({ keyword: 'vicarious_family', aliases: ["'s mom", "'s dad", "'s sister", "'s brother", "'s parents", "'s cousin", 'stepmom', 'stepdad'], domain: 'CONCEPT', category: 'RELATIONSHIP_VERB', weight: 0.82, confidence: 0.8, relationshipHint: 'FAMILY_RELATIONSHIP' }),
  ...
  // ── Lore collecting extension (skills, kinship, employment — see glossaryLoreCollecting.ts)
  ...(LORE_COLLECTING_GLOSSARY_ENTRIES as GlossaryEntry[]),
];
