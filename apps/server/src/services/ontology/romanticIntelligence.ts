...
const TYPE_RULES: Array<{ re: RegExp; type: RomanticRelationshipType; weight: number }> = [
  ...
  { re: /\bsoft\s+launch(?:ed|ing)?\b/i, type: 'dating', weight: 0.72 },
  { re: /\bdefine\s+the\s+relationship\b|\bdtr\b/i, type: 'dating', weight: 0.78 },
  { re: /\b(?:got|have)\s+the\s+ick\b|\bthe\s+ick\b/i, type: 'ex_girlfriend', weight: 0.75 },
  { re: /\bbreadcrum(?:b|bing)\b/i, type: 'situationship', weight: 0.7 },
  { re: /\btalking\s+again\b|\breconnected\b|\brekindling\b/i, type: 'dating', weight: 0.76 },
