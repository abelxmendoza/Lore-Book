...
const EVENT_PATTERNS: EventPattern[] = [
  ...
  { kind: 'travel', cues: ['traveled to', 'trip to', 'vacation', 'flew to', 'visited', 'went to', 'went on the trip'], confidence: 0.75 },
  ...
  { kind: 'social_event', cues: ['party', 'wedding', 'reunion', 'concert', 'festival', 'grew up together', 'gre up together', 'raised together', 'childhood friends'], confidence: 0.72 },
