...
export function evaluateEntityQuality(
  ...
  const productMeta = guardProductMetaCommentary(normalized);
  ...
  // Characters-only: reject process labels, job titles, media, software, and
  // unresolved relational references ("her friend") before they become cards.
