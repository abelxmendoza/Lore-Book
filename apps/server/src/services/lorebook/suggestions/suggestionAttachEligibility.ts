...
export function isAttachPlan(result: AttachDiagnostic | AttachPlan | undefined): result is AttachPlan {
  return !!result && (result.decision === 'ATTACH_EXACT' || result.decision === 'ATTACH_ALIAS') && 'target' in result;
}
