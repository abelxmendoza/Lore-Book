 ...
 *
 * Same surface form (e.g. "Vega") can mean an AI model in one span and a person in
...
const PUBLIC_FIGURE_LOCAL = /\b(ceo|founder|playing a joke|public figure)\b/i;
...
export function inferMentionType(
  ...
  // Versioned software labels: "5.6 Vega", "Opus 4.8", "Composer 2.5"
  if (
