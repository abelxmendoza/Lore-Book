...
import { memoryReviewQueueRouter } from './routes/memoryReviewQueue';
import { insightsRouter } from './routes/insights';
import { chatOrchestrationRouter } from './routes/chatOrchestration';
...
apiRouter.use('/perspectives', perspectivesRouter);
apiRouter.use('/mrq', memoryReviewQueueRouter);
apiRouter.use('/insights', insightsRouter);
apiRouter.use('/chat', chatOrchestrationRouter);
