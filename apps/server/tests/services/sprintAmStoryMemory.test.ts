  ...
  describe('AM-2 character memory profiles', () => {
    it('formats Uncle James as lived biography not generic uncle line', () => {
      const profile: CharacterMemoryProfile = {
        ...
        firstKnownOccurrence: '2024-01-15',
        lastKnownOccurrence: '2025-06-01',
        firstMentionedAt: '2024-01-10',
        lastMentionedAt: '2025-06-01',
    ...
    it('formats Jerry with project context', () => {
      const profile: CharacterMemoryProfile = {
        ...
        firstKnownOccurrence: '2024-05-25',
        lastKnownOccurrence: '2025-06-10',
        firstMentionedAt: '2024-05-20',
        lastMentionedAt: '2025-06-10',
